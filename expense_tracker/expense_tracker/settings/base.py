...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-xg7)&44+uuq)g)e2#zc#%1pt7bkugx67lwy3i_me!p43f4e&n^')
...
# Authentication backends (if using JWT in future)
# Add this if you plan to use JWT
